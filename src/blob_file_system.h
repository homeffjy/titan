...
class TitanFileSystem : public FileSystem {
 public:
  ...
  IOStatus CreateDirIfMissing(const std::string& dirname,
                              ...
                              IODebugContext* dbg) override {
    return GetAppropriateFS(dirname)->CreateDirIfMissing(dirname, options, dbg);
  }
  ...
  IOStatus GetAbsolutePath(const std::string& db_path, const IOOptions& options,
                           ...
                           IODebugContext* dbg) override {
    return GetAppropriateFS(db_path)->GetAbsolutePath(db_path, options,
                                                      output_path, dbg);
  }
 ...
 private:
  ...
  auto GetAppropriateFS(const std::string& fname)
    ...
    return IsBlobFile(fname) ? cloud_fs_ : base_fs_;
  }
